...
// Rendering the details of issues of the project in json
let issuesJson = document.getElementById('issue-data').getAttribute('data');

// parsing data
let issues = JSON.parse(issuesJson);

// getting elements where filtered issues will be shown
...
filterIssueForm.addEventListener('submit', function (e) {
  ...
  //creating a div and adding details of the filtered issues
  issueList.innerHTML = '';
